...
//below is importing and models to be used
...
public class Controller {
    ...
    //REGEX code to use for validation
    ...
    @FXML
    private Button btnApplyPackageChanges, btnDeletePkg, btnExit, btnInsertCustomer,  btnSaveCustomer,  btnUpdate,
    ...
    void btnAddProdOnMouseClick(MouseEvent event) {
     //Runs function to insert product on the button clicked
        InsertProduct(); }

    @FXML
    void btnAddSupplierOnMouseClick(MouseEvent event) {
        //Runs function to add  a supplier on the button clicked
        InsertSupplier(); }

    @FXML
    void btnClearProdOnMouseClick(MouseEvent event) {
        //Runs a function to clear Product input data on the button clicked
        ClearProductInputData(); }

    @FXML
    void btnClearSupplierOnMouseClick(MouseEvent event) {
        //Runs a function to clear Supplier input data on the button clicked
        ClearSupplierInputData(); }

    @FXML
    void btnUpdateProdOnMouseClick(MouseEvent event) {
        //Runs function to update a product on the button clicked
        InsertProduct(); }

    @FXML
    void btnUpdateSupplierOnMouseClick(MouseEvent event) {
        //Runs function to update a supplier on the button clicked
        InsertSupplier(); }
    ...
    public void onDeleteAgentBtnClick(MouseEvent mouseEvent) {
        ...
        a.show();
        //show image when an agent was deleted
        imgFired.toFront();
    ...
    void createBookingTableColumns()
    {
        ...
        //adds booking colums to the table
    ...
    private ObservableList<Booking> GetBookingsOfCustomer(int CustId)
    {
        ...
        //uses for loop to add bookings to the observable list
    ...
    void onInsertAgentBtnClick(MouseEvent event) {
        //runs a function to insert an agent when the button is clicked
        InsertAgent();
    }
    ...
    //    assert btnExit1 != null : "fx:id=\"btnExit1\" was not injected: check your FXML file." ;
        ...
        CheckLoginStartPage(); //make sure all credentials were or were not added to enable/disable tabs
...
//loads all agents into the table
    ...
    public void LoadAgencies(){
        ...
        //Bellow code adds column data for Agencies table
    ...
    public void InsertSupplier(){
     //Function to insert a supplier
        try {
            // VALIDATION code, when it arrives from travelling, will go here  :)
            if(true) {
                int supplierId = 999;
